    ...
    <table class="mui-table mui-table--bordered">
      ...
      <tbody>
        <tr v-for="item in data['series']">
          <td>{{ item.day_time }}</td>
          <td>{{ item.native_pv }}</td>
          <td>{{ item.native_uv }}</td>
          <td>{{ item.click_info.jd.click_times }}</td>
          <td>{{ item.click_info.taobao.click_times }}</td>
          <td>{{ item.abroad_pv }}</td>
          <td>{{ item.abroad_uv }}</td>
          <td>{{ item.click_info.others.click_times }}</td>
        </tr>
    </tbody>
    </table>
